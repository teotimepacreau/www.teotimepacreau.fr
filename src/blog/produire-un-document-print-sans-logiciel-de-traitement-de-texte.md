...
{% citationsmarginales "PERRET, Arthur. <a href='https://www.arthurperret.fr/cours/ecriture-scientifique-format-texte.html'><em>Cours sur l'écriture scientifique au format texte</em></a>. 2022" %}
...
{% citationsmarginales "BRASSARD, Louis-Olivier. <a href='https://debugue.ecrituresnumeriques.ca/saison-04/seance-03-les-langages-de-balisage/'><em>Extrait du cours de Debugue tes humanités sur les langages de balisage</em></a>. 2018" %}
...
{% citationsmarginales "FAUCHIE, Antoine. <a href='https://www.quaternum.net/2018/10/18/markdown-comme-condition-d-une-norme-de-l-ecriture-numerique/'><em>Extrait d'un billet de blog à propos du format Markdown</em></a>. 2018" %}
...
{% citationsmarginales "FAUCHIE, Antoine. <a href='https://hal.science/hal-03622394/document'><em>Extrait d'une interview à propos du protocole Git comme outil d'édition et d'écriture/em></a>. 2022" %}
Git, ce n’est pas un outil, c’est plutôt un protocole de travail. Git, c’est une façon de travailler, de gérer des documents dans l’espace et dans le temps. C’est un peu pompeux comme définition. Git répond au problème : « je travaille sur un projet avec plusieurs fichiers informatiques (n’importe lesquels) et je cherche à éviter d’avoir des titres à rallonge comme fichier_reluparXX_v1, v2, etc.
...
{% citationsmarginales "DUCAMP Christophe, Jeff. <a href='https://www.christopheducamp.com/note/tufte-css/'><em>Article CSS Tufte</em></a>. 2017" %}
